...
LIGUE1_TEAMS = {
    "psg": {
        ...
        "squad": {
            "GK": [
                {"name": "Gianluigi Donnarumma", "number": 99, "rating": 87, "age": 27},
                {"name": "Matvey Safonov", "number": 1, "rating": 78, "age": 25},
            ],
            "DEF": [
                {"name": "Achraf Hakimi", "number": 2, "rating": 86, "position": "DD", "age": 27},
                {"name": "Marquinhos", "number": 5, "rating": 86, "position": "DC", "age": 32},
                {"name": "Lucas Hernandez", "number": 21, "rating": 83, "position": "DC", "age": 30},
                {"name": "Nuno Mendes", "number": 25, "rating": 83, "position": "DG", "age": 24},
                {"name": "Willian Pacho", "number": 51, "rating": 82, "position": "DC", "age": 23},
                {"name": "Milan Skriniar", "number": 37, "rating": 80, "position": "DC", "age": 31},
                {"name": "Presnel Kimpembe", "number": 3, "rating": 78, "position": "DC", "age": 30},
            ],
            "MID": [
                {"name": "Vitinha", "number": 17, "rating": 85, "position": "MC", "age": 25},
                {"name": "Warren Zaïre-Emery", "number": 33, "rating": 83, "position": "MC", "age": 19},
                {"name": "Fabian Ruiz", "number": 8, "rating": 82, "position": "MC", "age": 30},
                {"name": "João Neves", "number": 87, "rating": 82, "position": "MC", "age": 21},
                {"name": "Lee Kang-in", "number": 19, "rating": 80, "position": "MOC", "age": 25},
            ],
            "FWD": [
                {"name": "Ousmane Dembélé", "number": 10, "rating": 85, "position": "AD", "age": 29},
                {"name": "Bradley Barcola", "number": 29, "rating": 83, "position": "AG", "age": 22},
                {"name": "Marco Asensio", "number": 11, "rating": 80, "position": "BU", "age": 30},
                {"name": "Randal Kolo Muani", "number": 23, "rating": 80, "position": "BU", "age": 27},
                {"name": "Gonçalo Ramos", "number": 9, "rating": 81, "position": "BU", "age": 25},
                {"name": "Désiré Doué", "number": 14, "rating": 79, "position": "AG", "age": 21},
            ],
        },
        "default_xi": {
            "formation": "4-3-3",
    ...
    "om": {
        ...
        "style": "Construction depuis l'arrière, pressing intense, jeu de passes courtes",
        "squad": {
            "GK": [
            ...
            "DEF": [
                {"name": "Amir Murillo", "number": 2, "rating": 76, "position": "DD", "age": 30},
                {"name": "Leonardo Balerdi", "number": 5, "rating": 80, "position": "DC", "age": 26},
                {"name": "Derek Cornelius", "number": 4, "rating": 77, "position": "DC", "age": 27},
                {"name": "Lilian Brassier", "number": 3, "rating": 77, "position": "DC", "age": 25},
                {"name": "Quentin Merlin", "number": 15, "rating": 75, "position": "DG", "age": 23},
                {"name": "Ulisses Garcia", "number": 21, "rating": 74, "position": "DG", "age": 28},
            ],
            "MID": [
                {"name": "Pierre-Emile Højbjerg", "number": 23, "rating": 82, "position": "MC", "age": 30},
                {"name": "Adrien Rabiot", "number": 25, "rating": 81, "position": "MC", "age": 31},
                {"name": "Valentin Rongier", "number": 8, "rating": 77, "position": "MC", "age": 30},
                {"name": "Amine Harit", "number": 10, "rating": 77, "position": "MOC", "age": 28},
            ],
            "FWD": [
                {"name": "Mason Greenwood", "number": 11, "rating": 81, "position": "AD", "age": 24},
                {"name": "Jonathan Rowe", "number": 18, "rating": 76, "position": "AG", "age": 22},
                {"name": "Neal Maupay", "number": 9, "rating": 76, "position": "BU", "age": 30},
                {"name": "Elye Wahi", "number": 7, "rating": 77, "position": "BU", "age": 22},
                {"name": "Luis Henrique", "number": 14, "rating": 76, "position": "AD", "age": 23},
                {"name": "Roberto De Zerbi Jr", "number": 20, "rating": 73, "position": "AG", "age": 21},
            ],
        },
        "default_xi": {
            "formation": "3-4-2-1",
            "lineup": [
                ...
                "Merlin", "Højbjerg", "Rabiot", "Greenwood",
                "Harit", "Rowe",
                "Maupay"
            ]
        }
    ...
    "ol": {
        ...
        "style": "Possession, jeu technique, construction patiente",
        "squad": {
            "GK": [
                {"name": "Anthony Lopes", "number": 1, "rating": 79, "age": 34},
                {"name": "Lucas Perri", "number": 30, "rating": 78, "age": 27},
            ],
            "DEF": [
                {"name": "Clinton Mata", "number": 2, "rating": 77, "position": "DD", "age": 32},
                {"name": "Moussa Niakhaté", "number": 3, "rating": 78, "position": "DC", "age": 29},
                {"name": "Duje Caleta-Car", "number": 15, "rating": 78, "position": "DC", "age": 30},
                {"name": "Abner", "number": 6, "rating": 77, "position": "DG", "age": 25},
                {"name": "Nicolas Tagliafico", "number": 23, "rating": 78, "position": "DG", "age": 33},
            ],
            "MID": [
                {"name": "Corentin Tolisso", "number": 8, "rating": 79, "position": "MC", "age": 32},
                {"name": "Maxence Caqueret", "number": 7, "rating": 79, "position": "MC", "age": 25},
                {"name": "Nemanja Matic", "number": 10, "rating": 78, "position": "MC", "age": 37},
                {"name": "Jordan Veretout", "number": 17, "rating": 77, "position": "MC", "age": 33},
                {"name": "Rayan Cherki", "number": 18, "rating": 80, "position": "MOC", "age": 22},
            ],
            "FWD": [
                {"name": "Alexandre Lacazette", "number": 91, "rating": 80, "position": "BU", "age": 35},
                {"name": "Ernest Nuamah", "number": 11, "rating": 76, "position": "AD", "age": 21},
                {"name": "Mama Baldé", "number": 9, "rating": 75, "position": "AD", "age": 29},
                {"name": "Gift Orban", "number": 14, "rating": 75, "position": "BU", "age": 23},
                {"name": "Malick Fofana", "number": 19, "rating": 77, "position": "AG", "age": 20},
            ],
        },
        "default_xi": {
            "formation": "4-3-3",
            "lineup": [
                ...
                "Caqueret", "Matic", "Tolisso",
                "Cherki", "Lacazette", "Fofana"
            ]
        }
    },
    "nice": {
